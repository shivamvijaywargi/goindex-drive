...
function nav(path) {
    ...
    <a href="https://github.com/shivamvijaywargi/goindex-drive" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Shivams Drive Index on Github'}">
...
if (search) {
	document.write('<script src="//cdn.jsdelivr.net/gh/shivamvijaywargi/goindex-drive@2.3/themes/material/cari.js"></script>');
}
